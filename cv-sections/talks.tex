...
%---------------------------------------------------------
    \cventry
    {Innovation in practice: Rockwool builds its own Gen AI tool} % Title
    {ComputerWorld Cloud \& AI Festival} % Event
    {Copenhagen} % Location
    {Sep 2025} % Dat(s)
    {
    ...
    \cventry
    {Assesing the Climate Impact of AI} % Title
    ...
    \cventry
    {Political AI} % Title
    {Socialdemokratiet} % Client
    {Christiansborg Palace} % Duration/Type
    {Sep 2024} % Date(s)
    {
