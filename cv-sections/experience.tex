...
\cventry
{Client: Rockwool \newline Role: Senior Machine Learning Engineer (GenAI)} % Job title
{RockGPT – Internal Chatbot System} % Organization
...
{Semantic Search on Biology Research Documents} % Organization
{}% {Data Scientist} % Location
{2023 - 2024} % Date(s)
{ % Description(s) of tasks/responsibilities
\begin{cvitems}
...
\cventry
{Client: Teknologisk Institut \newline Role: Senior Data Analyst} % Job title
{Course Planing Data Analysis} % Organization
{}% {Data Scientist} % Location
{2024 - 2024} % Date(s)
{ % Description(s) of tasks/responsibilities
\begin{cvitems}
